...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.chooseFolder = QToolButton(self.centralwidget)
        self.chooseFolder.setObjectName(u"chooseFolder")
        self.chooseFolder.setGeometry(QRect(520, 50, 31, 22))
        self.folderName = QLineEdit(self.centralwidget)
        self.folderName.setObjectName(u"folderName")
        self.folderName.setGeometry(QRect(150, 50, 351, 21))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.chooseFolder.setText(QCoreApplication.translate("mainWindow", u"...", None))
